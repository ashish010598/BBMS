		...
		<div class="container">
								<header class="jumbotron">
									...
									<div class="container">
										...
										<h1 style="color:black;text-align:center;font-family:Lato"><span style="color:red;">Blood</span> Confirmed</h1>
										<a href="managerlogin.php" class="btn btn-primary btn-lg">ORDER MORE</a>
									</div>
								</header>	
							</div>
	</body>
